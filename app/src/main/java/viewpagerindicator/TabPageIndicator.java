...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount > 1 && (widthMode == MeasureSpec.EXACTLY || widthMode == MeasureSpec.AT_MOST)) {
            if (childCount > 3) {
                ...
                mMaxTabWidth = MeasureSpec.getSize(widthMeasureSpec) / childCount;
            }
        } else {
            mMaxTabWidth = -1;
        }
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
        ...
        ColorStateList csl = (ColorStateList) resource.getColorStateList(R.color.tab_txt_color_selector);
    ...
    private class TabView extends TextView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if(isSelected()){
                ...
                float textPaintHeight = textPaint.measureText(getText().toString());
                Paint p = new Paint();
                p.setStrokeWidth(ScreenUtils.dip2px(getContext(),2));
                p.setColor(getCurrentTextColor());
                canvas.drawLine((getWidth() - textPaintWidth)/2 -5, getHeight(), (getWidth() + textPaintWidth)/2 +5, getHeight(), p);// 画线
            }
        }
        // huzhi
        public int getIndex() {
